...
public class SearchDonor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtLat=(TextView)findViewById(R.id.txtSLat);
        txtLng=(TextView)findViewById(R.id.txtSLng);
        grid = (GridView)findViewById(R.id.grid);
       	
        txtBG=(EditText)findViewById(R.id.txtSBloodGroup);
    ...
    public void searchblood(View v){
  		String bg;
  		...
  		try{
			...
			URL u=new URL("http://myspace.belgaumonline.com/ayesha/searchdonor.php?lat="+ savedLat + "&lng=" + savedLng + "&bg=" + bg);
